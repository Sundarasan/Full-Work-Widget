package com.adaptavant.workwidget.helpers;
...
public final class GoogleAuthHelper {
	 ...
	 */
	private static final String CLIENT_ID = "53654868127.apps.googleusercontent.com";
	/**
	 * Please provide a value for the CLIENT_SECRET constant before proceeding,
	 * set this up at https://code.google.com/apis/console/
	 */
	private static final String CLIENT_SECRET = "VQq_sSlKPJeT9mqmNkVOORit";

	/**
	 * Callback URI that google will redirect to after successful authentication
	 */
	private static final String CALLBACK_URI = FinalVariables.getGoogleOauthCallBackUri();
